...
"""
security-guard/scripts/scan.py (v 1.1)
Scans code for secrets and dangerous patterns.
"""
    ...
    for line_num, line in enumerate(content.splitlines(), 1):
        ...
        for pattern, label in SECRET_PATTERNS:
            if re.search(pattern, line):
                secrets.append(
                    {"line": line_num, "label": label, "snippet": line.strip()[:80]}
                )
